...
var Truncate = function (_Component) {
    ...
    function Truncate() {
        ...
        _this.renderLastLine = _this.renderLastLine.bind(_this);
        return _this;
    }
    ...
    _createClass(Truncate, [{
        ...
        value: function getLines() {
            var elements = this.elements,
                numLines = this.props.lines,
                targetWidth = this.state.targetWidth,
                innerText = this.innerText,
                measureWidth = this.measureWidth,
                renderLastLine = this.renderLastLine,
        ...
        key: 'renderLastLine',
        value: function renderLastLine(splicedText, originalArray) {
